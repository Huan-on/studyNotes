...
~~~
## 3、创建MyBatis的核心配置文件
>习惯上命名为` `，这个文件名仅仅只是建议，并非强制要求。将来整合Spring之后，这个配置文件可以省略，所以大家操作时可以直接复制、粘贴。
...
public class UserMapperTest {
    ...
    public void testInsertUser() throws IOException {
	    ...
	    //创建SqlSession对象，此时通过SqlSession对象所操作的sql都会自动提交，参数可以设置是否自动提交事务
